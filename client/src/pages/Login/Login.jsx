...
function Login() {
  ...
  const handleSubmit = useCallback(async (e) => {
    ...
    try {
      ...
      dispatch(loginSuccess({ user, token: "fake-jwt-token" }));
      navigate("/");
    } catch (err) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-primary to-primary-light p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm mt-1">Premium Electronics Store</p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 cursor-pointer transition-colors"
                >
                  {showPassword ? "🙈" : "👁️"}
                </button>
              </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-500 dark:text-gray-400">
              ...
              <Link to="/register" className="text-text-link dark:text-blue-400 font-semibold hover:underline">
                Create account
              </Link>
            </p>
          </div>
